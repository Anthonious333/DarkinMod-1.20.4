...
public enum ModArmorMaterials implements ArmorMaterial {
    DARKIN("darkin", 25, new int[] { 3, 8, 6, 3 }, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2f, 0.1f, () -> Ingredient.ofItems(ModItems.DARKIN_INGOT));
    ...
    public String getName() {
        return DarkinMod.MOD_ID + ":" + this.name;
    }
